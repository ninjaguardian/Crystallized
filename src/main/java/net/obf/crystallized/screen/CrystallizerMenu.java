...
import net.obf.crystallized.block.entity.CrystallizerBlockEntity;
...
public class CrystallizerMenu extends AbstractContainerMenu {
    ...
    public CrystallizerMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            ...
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 53, 5));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 76, 56));
        });
