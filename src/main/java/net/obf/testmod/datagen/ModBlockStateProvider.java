...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        axisBlock(((RotatedPillarBlock) ModBlocks.STRIPPED_CRYSTAL_LOG.get()), blockTexture(ModBlocks.STRIPPED_CRYSTAL_LOG.get()),
                new ResourceLocation(TestMod.MODID, "block/stripped_crystal_log_top"));
    ...
    private void blockItem(RegistryObject<Block> blockRegistryObject) {
        simpleBlockItem(blockRegistryObject.get(), new ModelFile.UncheckedModelFile(TestMod.MODID +
