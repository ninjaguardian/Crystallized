...
public enum ModArmorMaterials implements ArmorMaterial {
    CRYSTAL("crystal",50,new int[]{4,9,7,4}, 25, SoundEvents.ARMOR_EQUIP_GOLD, 4F, 0.1F, () -> Ingredient.of(ModItems.CRYSTAL_SHARD.get()));
    ...
    private static final int[] BASE_DURABILITY = { 11, 16, 15, 13 }; //netherite base dur
    ...
    public int getEnchantmentValue() {
        return this.enchantmentValue; //enchantmentValue or this.enchantmentValue?
    }
